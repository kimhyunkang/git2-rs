...
fn repo_lookup_commit() {
    let repo = git2::Repository::open("fixture").unwrap();
    let oid = from_str(&"21002f5d3f411fe990e13604273a51cd598a4a51").unwrap();
...
fn commit() {
    let repo = git2::Repository::open("fixture").unwrap();
    let parent_id = from_str(&"21002f5d3f411fe990e13604273a51cd598a4a51").unwrap();
    ...
    let treebuilder = git2::tree::TreeBuilder::from_tree(parent.tree());
